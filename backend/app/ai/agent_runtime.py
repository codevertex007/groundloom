...
class DeepAgentsAgentRuntime(AgentRuntime):
    ...
    def invoke(
        ...
        *,
        ...
        # Keep the historical facade monkeypatch seam used by deployment and
        # provider contract probes while the implementation lives in app.ai.
        from ..agent_runtime import build_checkpoint_provider as checkpoint_factory

        checkpoint_provider = checkpoint_factory(self.settings)
