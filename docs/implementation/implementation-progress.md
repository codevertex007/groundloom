...
| 2026-08-25 | Operational controls slice | Added migrations 009-010, worker heartbeats and bounded readiness/health snapshots, workspace daily token/cost budgets with durable waiting state, provider outage redaction/classification, and S3/Langfuse adapter failure tests; full backend suite passed 37 tests with one optional-provider skip, Ruff/mypy/migration verification passed. |
