...
| 2026-08-25 | Export and retention worker slice | Added migration 003, durable export leases/worker, project deletion request/status API, legal-hold policy seam, scoped unshared source/object/checkpoint cleanup, audit/outbox completion, and three focused worker tests; full backend suite now 30 passed with one optional-provider skip, frontend API tests 2 passed, frontend build passed, and docs validation passed for 166 documents. |
