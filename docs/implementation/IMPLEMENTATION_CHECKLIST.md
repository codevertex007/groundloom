...
- [x] **Phase 07:** complete reference UI, accessibility, reconnect/error/permission behavior (browser smoke and UI implementation evidence; automated accessibility gate remains)
