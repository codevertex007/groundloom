...
- [x] **Phase 08:** security, resilience, backup/restore, operations, capacity/cost hardening (local/deployment-shaped evidence; production restore/load/sandbox exercises remain external)
