...
Classes: `AUTHENTICATION_REQUIRED`, `PERMISSION_DENIED`, `RESOURCE_NOT_FOUND`, `INVALID_INPUT`, `INVALID_STATE`, `VERSION_CONFLICT`, `IDEMPOTENCY_CONFLICT`, `APPROVAL_REQUIRED/EXPIRED`, `BUDGET_EXCEEDED`, `SOURCE_NOT_READY`, `NO_EVIDENCE`, `CONTRADICTORY_EVIDENCE`, `MODEL_OUTPUT_INVALID`, `PROVIDER_TRANSIENT`, `DEPENDENCY_UNAVAILABLE`, `JOB_FAILED`, `CANCELLED`, `INTERNAL_ERROR`.
