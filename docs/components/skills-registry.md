...
Commands: create draft, fork, update draft, validate, request approval, publish, deprecate, select version. Publication never mutates bytes. Resolver returns only authorized active metadata/packages and pins project/run projections.
