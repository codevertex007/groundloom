...
| `SEC-AUTH-001..006` | `backend/tests/test_api_vertical_slice.py::test_cross_workspace_is_denied`; `backend/tests/test_security_boundaries.py::test_session_tenant_context_is_explicit_and_worker_context_is_distinct`; `backend/tests/test_adapters_and_jobs.py::test_local_object_store_rejects_escape_and_round_trips`; scoped tool/memory tests; live PostgreSQL RLS policy/role evidence remains a release gate |
