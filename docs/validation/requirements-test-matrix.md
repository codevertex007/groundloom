...
| `FR-SKILL-001..002` | `backend/tests/test_api_vertical_slice.py::test_skill_publish_validation_and_export`; `backend/tests/test_delegation_recovery.py::test_skill_repair_creates_immutable_version_then_validates_and_publishes`; `frontend/e2e/groundloom.spec.js` AI author lifecycle; draft/validate/repair/publish role path |
